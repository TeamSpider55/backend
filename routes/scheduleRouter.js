 ...
 */
router.get("/retrieve/single/:date", async (req, res) => {
...
/*
 */
router.get("/retrieve/many", async(req, res) => {
    let user = req.user._id;
...
router.get("/retrieve/many/:start/:end", async(req, res) => {
    let concreteUser = req.user._id;
