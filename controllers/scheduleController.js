...
const scheduleController1 = {

  /** Add schedule of the user to the data base (schedule collection)
    * @param {Number} time in mil-second that is between 0:0:0 -> 23:59:59.999 of the scheduled day
  ...
  addSchedule: async (unixTime, concreteUser) => {
    ...
    return (schedule == null)
      ...
      : { data: schedule, statusCode: 200 };
  },

  /* [done]Retrieve the schedules document using date and user
    * @param {Number} time in millis second that is between 0:0:0 -> 23:59:59 of the scheduled day
    * @param {String} the user id where this schedule belong to
  ...
  removeAllSchedule: async (concreteUser) => {
    ...
    return (report == null || report.ok !== 1)
      ? { data: errMess, statusCode: 400 }
      : { data: report.deletedCount, statusCode: 200 };
  },
